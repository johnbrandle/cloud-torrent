...
[![Releases](https://img.shields.io/github/release/johnbrandle/cloud-torrent.svg)](https://github.com/johnbrandle/cloud-torrent/releases) [![Releases](https://img.shields.io/github/downloads/johnbrandle/cloud-torrent/total.svg)](https://github.com/johnbrandle/cloud-torrent/releases)

See [the latest release](https://github.com/johnbrandle/cloud-torrent/releases/latest) or download and install it now with

```
curl https://i.jpillora.com/cloud-torrent! | bash
```

*Tip*: [Auto-run `cloud-torrent` on boot](https://github.com/johnbrandle/cloud-torrent/wiki/Auto-Run-on-Reboot)

**Docker**

[![Docker Pulls](https://img.shields.io/docker/pulls/johnbrandle/cloud-torrent.svg)][dockerhub] [![Image Size](https://images.microbadger.com/badges/image/johnbrandle/cloud-torrent.svg)][dockerhub]

[dockerhub]: https://hub.docker.com/r/johnbrandle/cloud-torrent/

``` sh
$ docker run -d -p 3000:3000 -v /path/to/my/downloads:/downloads johnbrandle/cloud-torrent
```
...
``` sh
$ go get -v github.com/johnbrandle/cloud-torrent
```
...
[Digital Ocean](https://m.do.co/c/011fa87fde07)
  ...
  12. Run `cloud-torrent` with:
    ...
    docker run --name ct -d -p 63000:63000 \
      ...
      johnbrandle/cloud-torrent --port 63000
...
$ cloud-torrent --help
  ...
  Read more:
    https://github.com/johnbrandle/cloud-torrent

```

### Future features

The next set of [core features can be tracked here](https://github.com/johnbrandle/cloud-torrent/issues?q=is%3Aopen+is%3Aissue+label%3Acore-feature). This feature set requires large structural changes and therefore requires a complete rewrite for best results. This rewrite is in progress in the `0.9` branch though it will take quite some time.

In summary, the core features will be:

* **Remote backends**

  It's looking like `0.9` will be more of a general purpose cloud transfer engine. It will be capable of transfering files from and source file-system to any destination file-system. A torrent can be viewed a folder with files, just like your local disk, and Dropbox. As long as it has a concept of files and folders, it could potentially be a cloud-torrent file-system backend. Track this issue https://github.com/johnbrandle/cloud-torrent/issues/24 for the list of proposed backends.

* **File Transforms**

  During a file tranfer, one could apply different transforms against the byte stream for various effect. For example, supported transforms might include: video transcoding (using ffmpeg), encryption and decryption, [media sorting](https://github.com/johnbrandle/cloud-torrent/issues/4) (file renaming), and writing multiple files as a single zip file.
